...
contract Staking is IStaking, Initializable {
    ...
    function stake(uint256 _level, uint256 _amount) external payable {
        ...
        // if (s.lock > 1) {
        //     IAirdrops(admin.airdrop()).setShareForEBSCReward(msg.sender);
        // }
        ...
        lpToken.safeTransferFrom(msg.sender, admin.airdrop(), _amount);
    }
    ...
    function unstake(uint256 _amount) external override {
        ...
        if (
            ...
            IAirdrops(admin.airdrop()).userPendingBNB(msg.sender);
        }
        IAirdrops(admin.airdrop()).withdrawEBSC(msg.sender, _amount);
    }
